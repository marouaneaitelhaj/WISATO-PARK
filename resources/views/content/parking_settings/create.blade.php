                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('parking_settings.store') }}">
                        ...
                        <div class="column">
                            ...
                            <div class="W-100">
                                <div class="form-group">
                                    <label for="name" class="text-md-right">{{ __('Slot Name') }} <span class="tcr text-danger">*</span></label>
                                    <input type="text" required class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" value="{{ old('name') }}" name="name">
                                    @if ($errors->has('name'))
                                    <span class="invalid-feedback" role="alert">
