            ...
            <div class="col-md-7">
                <div class="card">
                    ...
                    <div class="card-body" id="printDiv">
                        ...
                        <p class="dN tc fs-16 fwb">
                            {{ $settings->site_title ? $settings->site_title : config('app.name', 'Demo Parking') }}</p>
                        <img src="data:image/png;base64,{{ DNS1D::getBarcodePNG($parking->barcode, 'C128', 50, 1366) }}"
                            alt="barcode" class="w70 ml15" />
                        <table class="table table-condensed rTable">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="w10">:</td>
                                    <td class="w50">
                                        <b>{{ $parking->in_time->format(env('DATE_FORMAT', 'm-d-Y H:i:s')) }}</b></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="w10">:</td>
                                    <td class="w50"><b
                                            id="payble_amt">{{ $parking->amount != 0 ? round($parking->amount, 2) : round($amt, 2) }}</b>
                                    </td>
                                </tr>
                                @if ($parking->paid > 0)
                                    <tr>
                        ...
                        @if ($parking->paid < 1)
                            <table class="table table-condensed rTable">
                                <tbody>
                                    <form id="payForm" action="{{ route('parking.pay', ['parking' => $parking->id]) }}"
                                        method="post">
                                        @csrf
                                        <tr>
                                            ...
                                            <td class="w10">:</td>
                                            <td class="w50">
                                                <input tabindex="1" type="number" id="recive_amt" step="any"
                                                    placeholder="Recive Amount" class="form-control" required="">
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="w10">:</td>
                                            <td class="w50">
                                                <input tabindex="2" type="number" disabled id="return_amt"
                                                    placeholder="Return Amount" class="form-control">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="w40">Paid Amount</td>
                                            <td class="w10">:</td>
                                            <td class="w50">
                                                <input tabindex="3" type="number" id="paid_amt" name="paid_amt"
                                                    placeholder="Paid Amount" class="form-control" readonly=""
                                                    required="">
                    ...
                    <div class="card-footer">
                        @if ($parking->paid > 0)
                            <a href="{{ route('parking.index') }}" class="btn btn-warning" id="parking_list">Go to Parking
                                list</a>
