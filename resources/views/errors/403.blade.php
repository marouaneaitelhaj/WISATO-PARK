    ...
    <div
        ...
        <div class="w-full md:w-1/2">
            <div class="mb-10 lg:mb-20">
                <h1 class="font-black uppercase text-3xl lg:text-2xl text-black-500 mb-10">SMART PARKING</h1>
            </div>
            ...
            <div class="mb-20 md:mb-0">
                @if (Auth::user()->hasRole('client'))
                    <a href="/maps"
                        class="text-lg font-light outline-none focus:outline-none transform transition-all hover:scale-110 text-red-500 hover:text-red-600"><i
...
<div class="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a title="Buy me a beer" href="https://www.linkedin.com/company/onedustry-technologies/about/" target="_blank"
            class="block w-16 h-16 rounded-full transition-all shadow hover:shadow-lg transform hover:scale-110 hover:rotate-12">
            <img class="object-cover object-center w-full h-full rounded-full"
                src="https://media.licdn.com/dms/image/D4E0BAQGR3XDUW2nK5A/company-logo_200_200/0/1683988114539?e=1692230400&v=beta&t=HFBbczwAIMGIQ3oulJTlcYl7nKCF5z3e1A44qdWoXTc" />
        </a>
    </div>
</div>
