            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 441.85 285.44"
                ...
                <g id="OBJECTS">
                    ...
                    <g>
                        ...
                        <ellipse transform="rotate(-9.249 191.082 198.565)" class="st6" cx="191.05"
                            cy="198.49" rx="9.23" ry="9.23" />
                        <path class="st4"
                        ...
                        <ellipse transform="rotate(-9.249 292.07 198.575)" class="st6" cx="292.01"
                            cy="198.49" rx="9.23" ry="9.23" />
                        <path class="st4"
...
<div class="flex items-end justify-end fixed bottom-0 right-0 mb-4 mr-4 z-10">
    <div>
        <a title="Buy me a beer" href="https://www.linkedin.com/company/onedustry-technologies/about/"
            target="_blank"
