    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            <ul class="nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-dashboard-management" aria-expanded="false" aria-controls="ui-dashboard-management">
                        <i class="mdi mdi-compass-outline menu-icon"></i>
                        <span class="menu-title">Dashboard</span>
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-parkzone" aria-expanded="false" aria-controls="ui-parkzone">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-parking-setup" aria-expanded="false" aria-controls="ui-parking-setup">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-tariff" aria-expanded="false" aria-controls="ui-tariff">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-taem-management" aria-expanded="false" aria-controls="ui-team-management">
                ...
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="collapse" href="#ui-parking" aria-expanded="false" aria-controls="ui-parking">
                    ...
                    <div class="collapse" id="ui-parking">
                        <ul class="nav flex-column sub-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('parking.current_list') }}">Currnetly Parking
                                    List</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('parking.ended_list') }}">Ended Parking
                                    List</a>
                            </li>
                        </ul>
                    </div>
            ...
            <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
                <div class="navbar-menu-wrapper d-flex align-items-stretch">
                    ...
                    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                        <a class="navbar-brand brand-logo-mini" href="{{ route('home') }}"><img src="{{ asset($settings->logo) }}" alt="logo" /></a>
                    </div>
                    <ul class="navbar-nav">
                    ...
                    <ul class="navbar-nav navbar-nav-right">
                        <li class="nav-item nav-profile dropdown d-none d-md-block">
                            <a class="nav-link dropdown-toggle" id="profileDropdown" href="#" data-bs-toggle="dropdown" aria-expanded="false">
                                <div class="nav-profile-text"><i class="mdi mdi-account-circle mb-1 position-relative t-2"></i><span>{{ auth()->user()->name }}</span>
                                </div>
                            </a>
