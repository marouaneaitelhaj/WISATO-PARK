...
//     focusConfirm: false,
//     preConfirm: () => {
//       const galleryImages = Swal.getPopup().querySelector('#galleryImages').files;
...
function addImageToGallery(parkzoneId) {
  Swal.fire({
    ...
    html:
      ...
      '</div>' +
      '<button type="button" id="addImageInput" class="btn btn-primary"><i class="bi bi-plus"></i> Add Image</button>' +
      '</div>' +
      '</form>',
    showCancelButton: true,
    cancelButtonText: 'Cancel',
